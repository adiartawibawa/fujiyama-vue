<template>
  <div class="flex items-center">
    ...
    <button class="ml-3 text-sm text-gray-500 hover:text-gray-700 focus:text-indigo-500" type="button" @click="$emit('reset')">
      Reset
    </button>
...
<script>
import Dropdown from "@/Components/DataTables/Dropdown";
export default {
  components: {
    Dropdown,
  },
